"""CLI tool for passive validation (no controller) on GlucoBench windows."""
...
def main() -> int:
    """Run passive validation (no controller) and report metrics."""
    csv_path = (
    ...
    # Build simulator in VALIDATION MODE (no controller)
    ...
    print(f"\nRunning PASSIVE validation replay ({steps_required} steps)...")
    print("(Controller disabled - testing physiology + estimator fit only)\n")
    ...
    # Generate report
    print("\n" + "=" * 70)
    print("PASSIVE VALIDATION METRICS (No Controller)")
    print("=" * 70)
